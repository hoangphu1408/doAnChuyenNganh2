...
class TableTaiKhoanCuDan extends Component {
  constructor(props) {
    super(props);
    this.columns = [
      {
  ...
  render() {
    let { danhSachTaiKhoanCuDan } = this.props;
    return (
      <div>
        {this.renderEdit()}
        {this.renderEditPW()}
...
const mapStateToProps = (state) => {
  return {
    danhSachTaiKhoanCuDan: state.accountReducer.danhSachTaiKhoanCuDan,
  };
};
const mapDispatchToProps = (dispatch) => {
  return {
    saveListAccount: () => {
      dispatch(actions.layDanhSachTKCuDan());
    },
    editAccount: (data) => {
      dispatch(actions.chinhSuaTKCuDan(data));
    },
    editPassword: (data) => {
      dispatch(actions.thayDoiMatKhau(data));
    },
    editEmail: (data) => {
      dispatch(actions.thayDoiEmailCD(data));
    },
    deleteAccount: (data) => {
      dispatch(actions.xoaTKCuDan(data));
    },
  };
};
export default connect(mapStateToProps, mapDispatchToProps)(TableTaiKhoanCuDan);
